...
Deocoin::Breakpad::ExceptionHandler::ExceptionHandler(const std::string &dumpPath)
{
...
Deocoin::Breakpad::ExceptionHandler::~ExceptionHandler()
{
...
*/
void Deocoin::Breakpad::ExceptionHandler::dummyCrash()
{
    int *a = (int *)0x42;
