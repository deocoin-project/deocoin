...
// Copyright (c) 2018-2021, The Deocoin Group.
//
...
const uint64_t CRYPTONOTE_PUBLIC_ADDRESS_BASE58_PREFIX        = 0x2f58;
...
const uint64_t MONEY_SUPPLY                                   = UINT64_C(8600000000000000);
const uint64_t COIN                                           = 100000000;
const uint64_t TAIL_EMISSION_REWARD                           = 10000000; // 0.1 Coins
...
const uint64_t MAXIMUM_FEE_V1                                 = UINT64_C(100000);

const uint64_t MINIMUM_FEE_V2                                 = UINT64_C(1000);
...
const uint64_t MAX_REMOTE_NODE_FEE                            = UINT64_C(1000000000); // this equals 100 Coins
...
const uint64_t MIN_TX_MIXIN_SIZE_V1                           = 0;
...
/* Governance Fee and range // The Deocoin Foundation */
...
const char     CRYPTONOTE_NAME[]                             = "Deocoin";
const char     GENESIS_COINBASE_TX_HEX[]                     = "010301ff0001a2e2d38d3d029b2e4c0281c0b02e7c53291a94d1d0cbff8883f8024f5142ee494ffbbd08807121016e445497e339097337f430e551acfe3564068cd7570703965fb9ca6a4377c856";
...
const int      P2P_DEFAULT_PORT                              =  48007;
const int      RPC_DEFAULT_PORT                              =  48008;
const int      SERVICE_DEFAULT_PORT                          =  48009;
...
/* Governance Fee Wallets // The Deocoin Foundation */
const std::string GOVERNANCE_WALLET_ADDRESS                  = "";
const std::string GOVERNANCE_VIEW_SECRET_KEY                 = "";

const char *const SEED_NODES[] = {
    "192.168.116.173:48007",         //E
    "192.168.116.174:48007"         //E
