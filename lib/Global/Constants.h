// Copyright 2019-2021 (c) The Deocoin Group.
//
...
*/
const uint64_t addressPrefix = 0x2f58;

/*!
    Your coins 'Ticker', e.g. Monero = XMR, Bitcoin = BTC
*/
const std::string ticker = "DEC";

/*!
    The name of your deamon
*/
const std::string daemonName = "deocoind";
...
*/
const std::string contactLink = "http://chat.deocoin.space";
